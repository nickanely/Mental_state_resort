...
from agile_project.scripts.MSI_2.quote_loader import load_quote
from agile_project.scripts.MSI_2.teams_notifier import send_to_teams
from agile_project.scripts.MSI_2.image_loader import load_image
